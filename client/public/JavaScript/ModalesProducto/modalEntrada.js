...
async function registrarEntrada() {
	...
	const movimiento = {
		...
		cantidad, // Ahora representa UNIDADES REALES producidas
		observacion
	};
	try {
		...
		if (typeof cargarProductos === 'function') {
			...
			// Nota: Se asume que la propiedad del objeto se llama stock_actual o stock
			const stockProp = productoSeleccionado.hasOwnProperty('stock_actual') ? 'stock_actual' : 'stock';
